...
CPPPATH_NODE = '/usr/local/Cellar/node/0.4.2/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-Wall', '-O3']
...
LIBDIR = '/usr/local/lib/node_modules:/usr/local/lib/node:'
LIBPATH_HIREDIS = 'default'
LIBPATH_NODE = '/usr/local/Cellar/node/0.4.2/lib'
LIBPATH_ST = '-L%s'
LIB_HIREDIS = 'hiredis'
LIB_ST = '-l%s'
...
PREFIX = '/usr/local'
PREFIX_NODE = '/usr/local/Cellar/node/0.4.2'
